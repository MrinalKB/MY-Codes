...
Original file is located at
    https://colab.research.google.com/drive/1BukMGubQ8JHRNunOLlDnBCtDyRjziSOT
"""
...
inputs=tokenizer(["Wake Up Ayush, you just got a call from WHO for a trip to america"], padding=True,return_tensors="tf")
